...
const getProductList = async (req, res) => {
  const data = await pool.execute(
    `SELECT product.id, product.name,product.store_id,product.category_id, product.amount, category.category_name,category.category_en_name, store.name AS store_name, price,sold_amount FROM product 
